      ...
      body: Column(
        ...
        children: [
                ...
                child: InkWell(
                  ...
                  child: Row(
                    children: const [
                      ...
                      Text('Go back', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w400, color: Color(0xFF27214D))),
                    ],
                  ),
                ),
              ),
          ...
          Container(
            ...
            child: ListView(
              children: [
                const Text('Quinoa Fruit Salad', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w500, color: Color(0xFF27214D))),
                ...
                const Expanded(child: Text('Red Quinoa, Lime, Honey, Blueberries, Strawberries, Mango, Fresh mint.', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF27214D), height: 1.7))),
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 10),
                  child: Divider(thickness: 1),
                ),
                const Expanded(child: Text('If you are looking for a new fruit salad to eat today, quinoa is the perfect brunch for you. make', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xFF000000), height: 1.7))),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: () {
                          setState(() {});
                          baskets.add(argumentCommon['image']);
                          baskets.add(argumentCommon['name']);
                          baskets.add(argumentCommon['sent']);
                        },
                        child: const Text('Add to basket', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500))),
                  ],
                ),
              ],
            ),
